...
namespace WU16.Kompassen.Web
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/kompassen").Include(
                "~/scripts/kompassen/navigation.js",
                "~/scripts/kompassen/start.js",
                "~/scripts/kompassen/courses.js",
                "~/scripts/kompassen/students.js"));
        }
    }
}
